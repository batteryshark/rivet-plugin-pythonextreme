...
async function runPythonScript(code, args = [], python_path = "python", mod_path = "", conda_env = "", conda_path = "conda") {
  const filePath = (0, import_node_path3.join)((0, import_node_os4.tmpdir)(), `temp_python_script_${Date.now()}.py`);
  if (code === "") {
...
` + code;
  ...
  await (0, import_promises2.writeFile)(filePath, code);
